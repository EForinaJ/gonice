...
moment.locale('zh-cn')
import DForm from "./components/type/DForm"
import DTable from "./components/type/DTable"
export default {
    name: 'DictTypeList',
    components:{
        DTable,
    ...
    methods:{
        ...
        ...mapActions('dictType',["dictList"]),
        // 数据请求
        async getList () {
            this.loading = true
            try {
                const data = await this.dictList(this.queryParam)
