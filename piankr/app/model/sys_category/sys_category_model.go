...
// arModel is a active record design model for table sys_category operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_category.
	Table = "sys_category"
	// Model is the model object of sys_category.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sys_category.
	Columns = struct {
		CateId           string //                                  
        ParentId         string // 顶级分类                         
        CateName         string // 分类名称                         
        CateSlug         string // 分类别名                         
        CateImg          string // 分类背景图                       
        CateKey          string // 分类关键字                       
        CateSort         string // 分类排序                         
        Status           string // 分类状态                         
        DelFlag          string // 删除标志（0代表存在 2代表删除）  
        CateModule       string // 分类栏目                         
        CreateBy         string // 创建者                           
        CreateTime       string // 创建日期                         
        UpdateBy         string // 更新者                           
        UpdateTime       string // 更新日期                         
        Remark           string // 备注                             
        CateDescription  string // 分类描述
	}{
		CateId:          "cate_id",           
        ParentId:        "parent_id",         
        CateName:        "cate_name",         
        ...
        Status:          "status",            
        DelFlag:         "del_flag",          
        CateModule:      "cate_module",       
        CreateBy:        "create_by",         
        CreateTime:      "create_time",       
        UpdateBy:        "update_by",         
        UpdateTime:      "update_time",       
        Remark:          "remark",            
        CateDescription: "cate_description",
	}
)
