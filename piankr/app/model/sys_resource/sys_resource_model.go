...
// arModel is a active record design model for table sys_resource operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_resource.
	Table = "sys_resource"
	// Model is the model object of sys_resource.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sys_resource.
	Columns = struct {
		ResourceId     string //                                     
        ...
        DownAddress    string // 下载地址                            
        DownPass       string // 网盘密码                            
        DownGet        string // 提取码                              
        Auth           string // 获取权限                            
        Price          string // 价格                                
        Cover          string // 封面                                
        Demo           string // 演示文件                            
        Customs        string // 自定义属性                          
        Status         string // 状态0正常，1未审核 ，2 草稿，3禁用  
        IsHot          string // 推荐0为不推荐 1推荐                 
        CreateBy       string // 创建者                              
        CreateTime     string // 创建时间                            
        UpdateBy       string // 更新者                              
        UpdateTime     string // 更新时间                            
        ResourceDesc   string // 介绍                                
        Likes          string // 点赞数                              
        Views          string // 阅读数                              
        Collects       string // 收藏数
	}{
