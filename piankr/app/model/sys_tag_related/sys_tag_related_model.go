...
// arModel is a active record design model for table sys_tag_related operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_tag_related.
	Table = "sys_tag_related"
	// Model is the model object of sys_tag_related.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sys_tag_related.
	Columns = struct {
		TagId       string //   
        ResourceId  string //
	}{
