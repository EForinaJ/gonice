...
// arModel is a active record design model for table sys_circle operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_circle.
	Table = "sys_circle"
	// Model is the model object of sys_circle.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sys_circle.
	Columns = struct {
		CircleId    string //                                  
        CircleName  string // 圈子名称                         
        CircleDesc  string // 圈子描述                         
        CircleImg   string // 圈子背景图                       
        CateId      string // 圈子所属分类                     
        UserId      string // 管理者                           
        JoinType    string // 圈子加入的权限类型               
        JoinValue   string // 加入值                           
        CreateBy    string // 创建者                           
        ...
        Remark      string // 备注                             
        PostCount   string // 帖子数量                         
        JoinCount   string // 加入数量
	}{
		CircleId:   "circle_id",    
