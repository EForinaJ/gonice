...
// arModel is a active record design model for table sys_gruop operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_gruop.
	Table = "sys_gruop"
	// Model is the model object of sys_gruop.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sys_gruop.
	Columns = struct {
		GruopId     string //                               
        GruopName   string // 小组名称                      
        GruopType   string // 小组标识                      
        GruopImg    string // 小组图标                      
        DownTimes   string // 下载次数                      
        OpenType    string // 开通方式（1 积分 ， 2 付费）  
        OpenValue   string // 开通费用                      
        Validity    string // 有效期                        
        AuthModule  string // 权限模块                      
        Status      string // 小组状态( 0: 否，1：是)       
        Remark      string // 备注                          
        CreateBy    string // 创建者                        
		...
		GruopId:    "gruop_id",     
        GruopName:  "gruop_name",   
        GruopType:  "gruop_type",   
        GruopImg:   "gruop_img",    
