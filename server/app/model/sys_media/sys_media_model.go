...
// arModel is a active record design model for table sys_media operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_media.
	Table = "sys_media"
	// Model is the model object of sys_media.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sys_media.
	Columns = struct {
		MediaId     string //                                     
        UserId      string // 上传的用户                          
        Link        string // 文件链接                            
